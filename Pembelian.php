    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
      ...
      <div class="offcanvas-body">
        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
          <li class="nav-item">
            <a class="nav-link" aria-current="page" href="index.php"><h1>- Produk</h1></a>
          </li>
          <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="Pembelian.php"><h1>- Pembelian</h1></a>
          </li>
        </ul>
      </div>
    </div>
...
<br>
    ...
    <h1 align="center">RIWAYAT PEMBELIAN</h1>
...
<br>
    ...
    <thead style="border-bottom: 10px solid;">
        <tr>
            <th class="padding1"><h4>ID Pembelian</h4></th>
            <th><h4>Nama Pelanggan</h4></th>
            <th><h4>Tanggal Pembelian</h4></th>
            <th><h4>ID Barang</h4></th>
        </tr>
    </thead>
    ...
    <tbody>
        ...
        <tr >
            <td class="padding2"><h4><?= $data['Id_pembelian'] ?></h4></td>
            <td><h4><?= $data['Nama_pelanggan'] ?></h4></td>
            <td><h4><?= $data['Tanggal_pembelian'] ?></h4></td>
            <td><h4><?= $data['Id_barang'] ?></h4></td>
        </tr>
